...
//        let viewModel = isOpened ? AlertExitOrNotViewModel(title: "메인", coordinator: coordinator) : AlertExitOrNotViewModel(title: "메인", coordinator: coordinator)
//        let scene: SceneType = isOpened ? ExitScene.alertExitOrNot(viewModel as! AlertExitOrNotViewModel) : LoginScene.login(viewModel as! LoginViewModel)
